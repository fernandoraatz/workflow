...
def sender_rabbitmq(user,password):
    ...
    connection = pika.BlockingConnection(pika.ConnectionParameters(host='10.240.80.55', virtual_host='contenthub',credentials=pika.PlainCredentials(username=user,password=password)))
...
sender_rabbitmq('usr_edg2_dev', 'A5rbzgmH9PUg1')
print('sending edg3 usr')
sender_rabbitmq('usr_edg3_dev', 'XEjrbzgmH9PUgc')
print('sending edg4 usr')
sender_rabbitmq('usr_edg4_dev', 'cH493jwAbVtJo9')